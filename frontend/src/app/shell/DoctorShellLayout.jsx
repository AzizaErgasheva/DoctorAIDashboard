      ...
      >
        ...
        <Box sx={{ p: '20px 20px 16px', borderBottom: '1px solid #eef2f7' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            >
                <Typography sx={{ color: '#fff', fontSize: 14, fontWeight: 600 }}>D</Typography>
            </Box>
            <Box>
              <Typography sx={{ fontSize: 17, fontWeight: 600, color: '#1a2535', lineHeight: 1.2 }}>
                Doctor Dashboard
              </Typography>
            </Box>
          </Box>
